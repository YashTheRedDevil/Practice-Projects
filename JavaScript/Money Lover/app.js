...
var budgetController = (function () {
    ...
    var calculcateTotal = function (type) {
        var sum = 0;
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            //4. Calculate the percentage of income that we spent
...
var uiController = (function () {
    ...
    return {
        getinput: function () {
            return {
                type: document.querySelector(DOMStrings.inputType).value, //returns inc or ex
...
var controller = (function (budgetCtrl, uiCtrl) {
    ...
    var ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            //STEP 2 Add item to budgetController
            newItem = budgetController.addItem(input.type, input.description, input.value);

            //STEP 3. Add new item to UI
            uiController.addListItem(newItem, input.type);

            //STEP 4. Clear the Fields
            uiController.clearFields();

            //STEP 5. Calculate and update budget
            updateBudget();

            //STEP 6. Calculate and update percentages
            updatePercentages();
        }
    };
